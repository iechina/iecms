...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 ...
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">   
    ...
    <tr> 
      ...
      <td><input type="text" name="site_name" value="<?php echo ($f_siteName); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：微乾隆官网</span>
	...
	<td  height="48" align="right"><strong>全局认证服务号说明：</strong></td>

      <td><strong>下面2项需要认证服务号开发者ID！ 认证订阅号只有分享权限，无授权获取用户基本信息权限！</strong>
	...
	<tr> 
      ...
      <td  height="48" align="right"><strong>全局认证服务号appId：</strong></td>

      <td><input type="text" name="site_appId" value="<?php echo ($f_appId); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:wx8dfa28e1ssaef9e4 </span>

    </tr> 

	 <tr> 

      <td  height="48" align="right"><strong>全局认证服务号appSecret：</strong></td>

      <td><input type="text" name="site_appSecret" value="<?php echo ($f_appSecret); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:8d7c50865a53d41d38dc61af0f258f03</span>
	 ...
	 <tr> 
      ...
      <td><input type="text" name="site_url" value="<?php echo ($f_siteUrl); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://www.weiqianlong.com</span>

    </tr>  
     <tr> 

      <td  height="48" align="right"><strong>微企秀地址：</strong></td>

      <td><input type="text" name="eqxsiteurl" value="<?php echo ($eqx_siteUrl); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://www.eqx.weiqianlong.com</span>

    </tr> 
     <tr> 

      <td  height="48" align="right"><strong>微企秀数据库名称址：</strong></td>
    ...
    <tr> 
      ...
      <td  height="48" align="right"><strong>微企秀数据库帐号：</strong></td>
    ...
    <tr> 
      ...
      <td  height="48" align="right"><strong>微企秀数据库密码：</strong></td>
