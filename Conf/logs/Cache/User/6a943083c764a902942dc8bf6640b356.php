		...
		<form class="form" method="post" action="">
			...
			<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
				<tbody>
					<tr>
						...
						<td>
							<input type="text" name="keyword" id="keyword" value="<?php echo ($kefu["keyword"]); ?>" class="px" style="width:550px;">
						</td>
					</tr>
					<tr>
						<th>标题：</th>
						<td>
							<input type="text" name="title" id="title" value="<?php echo ($kefu["title"]); ?>" class="px" style="width:550px;">
						</td>
					</tr>
					<tr>
						<th>封面图片：</th>
						<td>
							<input type="text" name="picurl" id="picurl" value="<?php echo ($kefu["picurl"]); ?>" class="px" style="width:550px;">
							<script src="/tpl/static/upyun.js">
</script> <a href="#" onclick="upyunPicUpload('picurl',700,420,'<?php echo ($token); ?>')" class="a_upload"> 上传 </a>  <a href="#"  class="a_upload" onclick="viewImg('picurl')"> 预览 </a> 
						</td>
					</tr>
					<tr>
						<th width="200">内容介绍：</th>
						<td>
							<textarea style="width:550px;height:75px"  name="text" id="text" class="px"><?php echo ($kefu["text"]); ?></textarea>
							<br/>最多填写120个字</td>
					</tr>
                   <tr>
					<th>客服链接：</br>(直接聊天)</th>
					<td>
						<input type="text" name="info2" id="info2" value="<?php echo ($kefu["info2"]); ?>" class="px" style="width:550px;">
					
					<br>	<span class="red">例如&nbsp;http://kefu6.kuaishang.com.cn/bs/im.htm?cas=10128___177444&fi=10282</span></td>
					</tr>
					<tr>
						<th>客户端下载：</th>
						<td><a style="color:#F00; font-size:15px" target="_blank" href="http://www.kuaishang.cn">快商通</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="color:#F00; font-size:15px" target="_blank" href="http://qiao.baidu.com/home/">百度商桥</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="color:#F00; font-size:15px" target="_blank" href="https://meiqia.com/">美洽</a>
						</td>
					</tr>
					</tbody>
		</table>
			...
			<tbody>
					<tr>
						...
						<td>
							<input type="radio" value="1" <?php if($kefu["status"] == 1): ?>checked="checked"<?php endif; ?>name="status"/>开启
							<input type="radio" value="0" <?php if($kefu["status"] == 0): ?>checked="checked"<?php endif; ?>name="status"/>关闭</td>
						<th><span class="red">*</span>微商城客服状态：</th>
						<td>
							<input type="radio" value="1" <?php if($kefu["sc"] == 1): ?>checked="checked"<?php endif; ?>name="sc"/>开启
							<input type="radio" value="0" <?php if($kefu["sc"] == 0): ?>checked="checked"<?php endif; ?>name="sc"/>关闭</td>
					</tr>
					<tr>
						<th><span class="red">*</span>微餐饮客服状态：</th>
						<td>
							<input type="radio" value="1" <?php if($kefu["cy"] == 1): ?>checked="checked"<?php endif; ?>name="cy"/>开启
							<input type="radio" value="0" <?php if($kefu["cy"] == 0): ?>checked="checked"<?php endif; ?>name="cy"/>关闭</td>
						<th><span class="red">*</span>微论坛客服状态：</th>
						<td>
							<input type="radio" value="1" <?php if($kefu["lt"] == 1): ?>checked="checked"<?php endif; ?>name="lt"/>开启
							<input type="radio" value="0" <?php if($kefu["lt"] == 0): ?>checked="checked"<?php endif; ?>name="lt"/>关闭</td>
					</tr>
					<tr>
						
						<th><span class="red">*</span>微会员客服状态：</th>
						<td>
							<input type="radio" value="1" <?php if($kefu["hyk"] == 1): ?>checked="checked"<?php endif; ?>name="hyk"/>开启
							<input type="radio" value="0" <?php if($kefu["hyk"] == 0): ?>checked="checked"<?php endif; ?>name="hyk"/>关闭</td>
					
					<th><span class="red">*</span>微招聘客服状态：</th>
						<td>
							<input type="radio" value="1" <?php if($kefu["zp"] == 1): ?>checked="checked"<?php endif; ?>name="zp"/>开启
							<input type="radio" value="0" <?php if($kefu["zp"] == 0): ?>checked="checked"<?php endif; ?>name="zp"/>关闭</td>
					</tr>
					<tr>
						<th><span class="red">*</span>微汽车客服状态：</th>
						<td>
							<input type="radio" value="1" <?php if($kefu["car"] == 1): ?>checked="checked"<?php endif; ?>name="car"/>开启
							<input type="radio" value="0" <?php if($kefu["car"] == 0): ?>checked="checked"<?php endif; ?>name="car"/>关闭</td>
						<th><span class="red">*</span>微医疗客服状态：</th>
						<td>
							<input type="radio" value="1" <?php if($kefu["yiliao"] == 1): ?>checked="checked"<?php endif; ?>name="yiliao"/>开启
							<input type="radio" value="0" <?php if($kefu["yiliao"] == 0): ?>checked="checked"<?php endif; ?>name="yiliao"/>关闭</td>
					</tr>
					<tr>
						<tr>
							<th><span class="red">*</span>微教育客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["jiaoyu"] == 1): ?>checked="checked"<?php endif; ?>name="jiaoyu"/>开启
								<input type="radio" value="0" <?php if($kefu["jiaoyu"] == 0): ?>checked="checked"<?php endif; ?>name="jiaoyu"/>关闭</td>
							<th><span class="red">*</span>微酒店宾馆客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["jdbg"] == 1): ?>checked="checked"<?php endif; ?>name="jdbg"/>开启
								<input type="radio" value="0" <?php if($kefu["jdbg"] == 0): ?>checked="checked"<?php endif; ?>name="jdbg"/>关闭</td>
						</tr>
						<tr>
							<th><span class="red">*</span>找房子客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["fc"] == 1): ?>checked="checked"<?php endif; ?>name="fc"/>开启
								<input type="radio" value="0" <?php if($kefu["fc"] == 0): ?>checked="checked"<?php endif; ?>name="fc"/>关闭</td>
							<th><span class="red">*</span>微美容客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["beauty"] == 1): ?>checked="checked"<?php endif; ?>name="beauty"/>开启
								<input type="radio" value="0" <?php if($kefu["beauty"] == 0): ?>checked="checked"<?php endif; ?>name="beauty"/>关闭</td>
						</tr>
						<tr>
							<th><span class="red">*</span>微健身客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["fitness"] == 1): ?>checked="checked"<?php endif; ?>name="fitness"/>开启
								<input type="radio" value="0" <?php if($kefu["fitness"] == 0): ?>checked="checked"<?php endif; ?>name="fitness"/>关闭</td>
							<th><span class="red">*</span>微政务客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["gover"] == 1): ?>checked="checked"<?php endif; ?>name="gover"/>开启
								<input type="radio" value="0" <?php if($kefu["gover"] == 0): ?>checked="checked"<?php endif; ?>name="gover"/>关闭</td>
						</tr>
						<tr>
							<th><span class="red">*</span>微食品客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["food"] == 1): ?>checked="checked"<?php endif; ?>name="food"/>开启
								<input type="radio" value="0" <?php if($kefu["food"] == 0): ?>checked="checked"<?php endif; ?>name="food"/>关闭</td>
							<th><span class="red">*</span>微旅游客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["travel"] == 1): ?>checked="checked"<?php endif; ?>name="travel"/>开启
								<input type="radio" value="0" <?php if($kefu["travel"] == 0): ?>checked="checked"<?php endif; ?>name="travel"/>关闭</td>
						</tr>
						<tr>
							<th><span class="red">*</span>微花店客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["flower"] == 1): ?>checked="checked"<?php endif; ?>name="flower"/>开启
								<input type="radio" value="0" <?php if($kefu["flower"] == 0): ?>checked="checked"<?php endif; ?>name="flower"/>关闭</td>
							<th><span class="red">*</span>微物业客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["property"] == 1): ?>checked="checked"<?php endif; ?>name="property"/>开启
								<input type="radio" value="0" <?php if($kefu["property"] == 0): ?>checked="checked"<?php endif; ?>name="property"/>关闭</td>
						</tr>
						<tr>
							<th><span class="red">*</span>微ktv客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["ktv"] == 1): ?>checked="checked"<?php endif; ?>name="ktv"/>开启
								<input type="radio" value="0" <?php if($kefu["ktv"] == 0): ?>checked="checked"<?php endif; ?>name="ktv"/>关闭</td>
							<th><span class="red">*</span>微酒吧客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["bar"] == 1): ?>checked="checked"<?php endif; ?>name="bar"/>开启
								<input type="radio" value="0" <?php if($kefu["bar"] == 0): ?>checked="checked"<?php endif; ?>name="bar"/>关闭</td>
						</tr>
						<tr>
							<th><span class="red">*</span>微装修客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["fitment"] == 1): ?>checked="checked"<?php endif; ?>name="fitment"/>开启
								<input type="radio" value="0" <?php if($kefu["fitment"] == 0): ?>checked="checked"<?php endif; ?>name="fitment"/>关闭</td>
							<th><span class="red">*</span>微婚庆客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["wedding"] == 1): ?>checked="checked"<?php endif; ?>name="wedding"/>开启
								<input type="radio" value="0" <?php if($kefu["wedding"] == 0): ?>checked="checked"<?php endif; ?>name="wedding"/>关闭</td>
						</tr>
						<tr>
							<th><span class="red">*</span>微宠物客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["affections"] == 1): ?>checked="checked"<?php endif; ?>name="affections"/>开启
								<input type="radio" value="0" <?php if($kefu["affections"] == 0): ?>checked="checked"<?php endif; ?>name="affections"/>关闭</td>
							<th><span class="red">*</span>微家政客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["housekeeper"] == 1): ?>checked="checked"<?php endif; ?>name="housekeeper"/>开启
								<input type="radio" value="0" <?php if($kefu["housekeeper"] == 0): ?>checked="checked"<?php endif; ?>name="housekeeper"/>关闭</td>
						</tr>
						<tr>
							<th><span class="red">*</span>微租赁客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["lease"] == 1): ?>checked="checked"<?php endif; ?>name="lease"/>开启
								<input type="radio" value="0" <?php if($kefu["lease"] == 0): ?>checked="checked"<?php endif; ?>name="lease"/>关闭</td>
							<th><span class="red">*</span>分享达人客服状态：</th>
							<td>
								<input type="radio" value="1" <?php if($kefu["fxdr"] == 1): ?>checked="checked"<?php endif; ?>name="fxdr"/>开启
								<input type="radio" value="0" <?php if($kefu["fxdr"] == 0): ?>checked="checked"<?php endif; ?>name="fxdr"/>关闭</td>
						</tr>
				...
				<tr>
							<th></th>
							<td>
								<input type="hidden" name="token" i value="<?php echo ($token); ?>">
