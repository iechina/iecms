...
<div class="content">
          ...
          <div class="cLineB"><h4>工单个人微信接收设置</h4></div>
...
<li <?php if($tab == 'help'): ?>class="selectTag"<?php endif; ?>>
 ...
 <div class="ftip" style="margin:25px auto 5px auto;">微信通知，将消息通知到个人微信号【可扩展接口】</div>
...
<TR>
  ...
  <TD><label for="radio3"><input id="radio3" class="radio" type="radio" name="statue" value="1"  <?php if(($info["statue"]) == "1"): ?>checked="checked"<?php endif; ?> /> 开启</label>&nbsp;&nbsp;<label for="radio4"><input class="radio" id="radio4" type="radio" name="statue" value="0" <?php if(($info["statue"]) == "0"): ?>checked="checked"<?php endif; ?> /> 关闭</label></TD>

</TR>
<TH valign="top" align="right" style="text-align:right">自动回复内容设置：</TH>
  
  <TD><input type="text" class="px" id="title1" value="<?php echo ($info["zdhf"]); ?>" name="zdhf" style="width:500px" ></TD>
  
</TR>
<TR>
<TH valign="top" align="right" style="text-align:right">处理bugOpenid：</TH>
  
  <TD><input type="text" class="px" id="title1" value="<?php echo ($info["openid"]); ?>" name="openid" style="width:500px" >在微信端回复“工单”后，保存配置即可</TD>
  
</TR>
<TR>
<TH valign="top" align="right" style="text-align:right">操作问题Openid：</TH>
  
  <TD><input type="text" class="px" id="title1" value="<?php echo ($info["czopenid"]); ?>" name="czopenid" style="width:500px" >在微信端回复“工单”后，保存配置即可</TD>
  
</TR>
<TR>
<TH valign="top" align="right" style="text-align:right">买前咨询Openid：</TH>
  
  <TD><input type="text" class="px" id="title1" value="<?php echo ($info["mqopenid"]); ?>" name="mqopenid" style="width:500px" >在微信端回复“工单”后，保存配置即可</TD>
  
</TR>
<TR>
<TH valign="top" align="right" style="text-align:right">客服昵称：</TH>
  
  <TD><input type="text" class="px" id="title1" value="<?php echo ($info["name"]); ?>" name="name" style="width:500px" ></TD>
  
</TR>
<TR>

  <TH valign="top" align="right" style="text-align:right">客服头像：</TH>

  <TD><input type="text" class="px"  name="head" id="head" value="<?php echo ($info["head"]); ?>" style="width:580px;"  />  <script src="/tpl/static/upyun.js?<?php echo date('YmdHis',time());?>"></script><a href="###" onclick="upyunPicUpload('head',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('head')">预览</a></TD>
