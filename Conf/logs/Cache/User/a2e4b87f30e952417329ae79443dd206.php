            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
                ...
                <tr>
				 ...
				 <tr>
                  <th><span class="red"></span>微店手机号：</th>
                  <td><input type="text" name="telphone" value="<?php echo ($info["telphone"]); ?>" 
				  class="px" tabindex="1" size="25">　用于使用微店功能，可以不填 </td>
                </tr>
                <tr>
				
                  <th><span class="red"></span>微店密码：</th>
                  <td><input type="password" name="password" value="<?php echo ($info["password"]); ?>" class="px" tabindex="1" size="25">　用于使用微店功能，可以不填 </td>
                </tr>
				 <tr>
