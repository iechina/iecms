...
<div class="content" >  
<div class="cLineB"><h4>微信墙设置</h4><a href="javascript:history.go(-1);"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a></div> 
<div class="msgWrap">
...
<TR>
  ...
  <TD>
    ...
    <a href="###" onclick="upyunPicUpload('logo',280,75,'<?php echo ($token); ?>')" class="a_upload">上传</a>
    <a href="###" onclick="viewImg('logo')" class="a_upload">预览</a>[280*75]
</TD>
</TR>

<TR>
  <TH valign="top"><label for="text">回复图片：</label></TH>
  <TD><input type="input" class="px" id="startbackground" value="<?php echo ($info["startbackground"]); ?>" name="startbackground" style="width:250px" value="<?php echo ($info["startbackground"]); ?>" > <script src="/tpl/static/upyun.js"></script><a href="###" onclick="chooseFile('startbackground','background')" class="a_upload">选择</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('startbackground',360,200,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('startbackground')" class="a_upload">预览</a> 最佳尺寸宽360px,高200px
</TD>
</TR>
<TR>
  <TH valign="top"><label for="text">背景：</label></TH>
  <TD><input type="input" class="px" id="background" value="<?php if($info['background'] == ''): ?>./tpl/static/wall/images/default_bg.jpg<?php else: echo ($info["background"]); endif; ?>" name="background" style="width:350px" value="<?php echo ($info["background"]); ?>" > <script src="/tpl/static/upyun.js"></script><a href="###" onclick="chooseFile('background','background')" class="a_upload">选择</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('background',1500,1000,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('background')" class="a_upload">预览</a>  默认为空会有更好的显示效果
</TD>
</TR>
<!--
<TR>
...
<TR>
  ...
  <TD><input type="input" class="px" id="qrcode" value="<?php echo ($info["qrcode"]); ?>" name="qrcode" style="width:350px" value="" >  <a href="###" onclick="upyunPicUpload('qrcode',800,800,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('qrcode')" class="a_upload">预览</a>
</TD>
</TR>
<TR>
...
<TR>
  <TH></TH>
  <TD><input type="hidden" value="<?php echo ($info["id"]); ?>" name="id" /><button type="submit"  name="button"  class="btnGreen left" >保存</button>　
  	</TD>
  </TR>
  </TBODY>
</TABLE>
