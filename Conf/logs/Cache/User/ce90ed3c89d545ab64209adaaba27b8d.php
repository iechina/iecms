...
<div class="cLineB">
  ...
  <h4>微乾隆工单管理系统</h4>
  <a href="<?php echo U('Gongdan/index',array(token=>$token));?>"  class="right btnGrayS vm" style="margin-top:-27px" >刷新</a>
  
 </div>
 <div class="ftip" style="margin:25px auto 5px auto;">评价信息统计：非常好：<?php echo ($pj_1); ?>&nbsp;&nbsp;&nbsp;&nbsp;一般般：<?php echo ($pj_2); ?>&nbsp;&nbsp;&nbsp;&nbsp;差评：<?php echo ($pj_3); ?>
</div>
  <div class="ftip" style="margin:25px auto 5px auto;">问题分类：
 <a style="margin-left:20px; float:none" href="<?php echo U('Gongdan/index',array('znfl'=>1,token=>$token));?>">BUG问题</a>
 <a  style="margin-left:20px; float:none"href="<?php echo U('Gongdan/index',array('znfl'=>2,token=>$token));?>">功能操作问题</a>
 <a style="margin-left:20px; float:none"  href="<?php echo U('Gongdan/index',array('znfl'=>3,token=>$token));?>">买前咨询</a>
 </div>      

 <div class="ftip" style="margin:25px auto 5px auto;">工单信息统计：总用户量：<?php echo ($total); ?>&nbsp;&nbsp;&nbsp;&nbsp;正在排队用户：<?php echo ($total_0); ?>&nbsp;&nbsp;&nbsp;&nbsp;受理中：<?php echo ($total_1); ?>&nbsp;&nbsp;&nbsp;&nbsp;受理完毕：<?php echo ($total_2); ?> 
 <a style="margin-left:20px" href="<?php echo U('Gongdan/index',array('statue'=>3,token=>$token));?>">排队中</a>
 <a  style="margin-left:20px"href="<?php echo U('Gongdan/index',array('statue'=>1,token=>$token));?>">受理中</a>
 <a style="margin-left:20px"  href="<?php echo U('Gongdan/index',array('statue'=>2,token=>$token));?>">处理完毕</a>
  <a style="margin-left:20px"  href="<?php echo U('Gongdan/index',array(token=>$token));?>">全部</a></div>
...
<th  style=" width:100px;text-align:center">微信名称</th>
<th style=" width:30px;text-align:center">号数</th>

<th style=" width:80px;text-align:center">工单状态</th>
...
<td style="text-align:center"><div class="cateimg" style="margin-left:20px"><img src="<?php echo ($vo["headimgurl"]); ?>" class="cateimg_small"  /><img src="<?php echo ($vo["headimgurl"]); ?>" class="cateimg_big"  /></div></td>
...
<td style="text-align:center"><?php if(($vo["statue"]) == "0"): ?><p style="color:rgb(20, 1, 186)" >排队中......</p><?php endif; if(($vo["statue"]) == "1"): ?><p  style="color:red">受理中......</p><?php endif; if(($vo["statue"]) == "2"): ?>受理完毕<?php endif; ?></td>
...
<td class="norightborder" width="120">
 ...
 <a href="<?php echo U('Gongdan/statue',array('id'=>$vo['id'],'statue'=>'1',token=>$vo['token'],wecha_id=>$vo['wecha_id']));?>">受理中</a>

	<a href="<?php echo U('Gongdan/statue',array('id'=>$vo['id'],'statue'=>2,token=>$vo['token'],wecha_id=>$vo['wecha_id']));?>">受理完毕</a>

	<a href="<?php echo U('Gongdan/notice',array('openid'=>$vo['wecha_id'],token=>$vo['token']));?>">通知</a>
    <a href="<?php echo U('Gongdan/msgrecord',array('id'=>$vo['id'],token=>$vo['token'],wecha_id=>$vo['wecha_id']));?>">记录</a>
     <a href="<?php echo U('Gongdan/detail',array('id'=>$vo['id'],token=>$vo['token'],wecha_id=>$vo['wecha_id']));?>">详情</a>
     <a href="<?php echo U('Gongdan/del',array('id'=>$vo['id'],token=>$vo['token'],wecha_id=>$vo['wecha_id']));?>">删除工单</a>
