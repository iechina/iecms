...
class LinkAction extends UserAction{
	...
	public function modules(){
		...
		array('module'=>'Vcard','linkcode'=>'','name'=>$this->modules['Vcard'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		array('module' => 'Jingcai', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Jingcai&a=index&token=' . $this->token) . '&wecha_id={wechat_id}', 'name' => $this->modules['Jingcai'], 'sub' => 0, 'canselected' => 1, 'linkurl' => '', 'keyword' => '竞猜', 'askeyword' => 1),		
