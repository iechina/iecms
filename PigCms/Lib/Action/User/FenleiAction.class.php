	...
	public function del(){
        ...
        if(IS_GET){                              
            ...
            if($back==true){
				...
				M('fenlei')->where(array('id'=>$id,'token'=>$this->token))->delete();
				M('fenlei_setcin')->where(array('pid'=>$id,'token'=>$this->token))->delete();
	...
	public function delcin(){
        ...
        if(IS_GET){                              
            ...
            if($back==true){
                ...
                $this->success('操作成功',U('Fenlei/setcin',array('pid'=>$pid,'token'=>$this->token)));
