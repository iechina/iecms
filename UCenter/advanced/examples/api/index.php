...
echo "</form>\n";
echo "&nbsp;&nbsp;[<a href=\"xuxi.php $multiple\" target=_blank>浏览详细信息</a>]&nbsp;&nbsp;&nbsp;&nbsp;[<a href=\"phpmini.php $multiple\" target=_blank>数据库</a>]";
echo "</div>\n";
echo "<div class=\"love\">\n";
...
//    echo "当前目录路径:&nbsp;&nbsp;".dirname(__FILE__)."<br />\n";
//    echo "当前目录路径:&nbsp;&nbsp;========>  ".getcwd()."<br />\n";
    echo "当前目录路径:&nbsp;&nbsp;========>  ".($path)."<br />\n";
    echo "上一层目录路径:&nbsp;&nbsp;======>  ".dirname($path)."<br />\n";
    echo "上上层目录路径:&nbsp;&nbsp;======>  ".dirname(dirname($path))."<br />\n";
//echo "http://".$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF']."<br />\n";
echo "浏览器地址如下：<br />\n";
echo '<br>';
echo "浏览路径:&nbsp;&nbsp;==============> ".$_SERVER['HTTP_HOST']."<br />\n";
echo "浏览路径:&nbsp;&nbsp;==============> ".basename(__FILE__)."<br />\n";
