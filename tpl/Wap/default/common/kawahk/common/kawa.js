...
function zk_build_card()
{
    ...
    {
        url = '/index.php?g=Wap&m=Kawahk&a=hcar_view&token={pigcms:$token}&id={pigcms:$id}&cardid={pigcms:$cardid}&cardid=' + kawa_data.cardid;
...
function on_modifymusic_click()
{
    ...
    var body_html = '';
    body_html += '<div style="position:relative; width:100%;background:rgb(100,86,86);height:70px;-webkit-border-radius:5px 5px 0px 0px;border-bottom:1px solid #89AF4C;"><div style="position:relative;float:left;left:10px;top:20px;height:40px;width:40px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -270px transparent "></div>';
    ...
    body_html += '<div  onclick="closeTBt()" style="position:relative;float:right;height:75px;width:75px;"><div style="position:relative;float:right;right:15px;top:20px;height:40px;width:40px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -135px transparent "></div></div></div>';
    ...
    var url="http://demo.weiqianlong.com/index.php?g=Wap&m=Kawahk&a=mp3";
    url=url+"&cardid=" + kawa_data.cardid;
    url=url+"&optfile=" + kawa_data.modify_optfile;
    if(kawa_data.modify_optwords != '#modify_optwords#')
    {
...
function on_modifyword_click()
{
    ...
    var html_body = '';
    html_body += '<div style="position:relative; width:100%;background:rgb(100,86,86);height:70px;-webkit-border-radius:5px 5px 0px 0px;border-bottom:0px;"><div style="position:relative;float:left;left:10px;top:20px;height:40px;width:40px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -315px transparent "></div>';//<img style="padding-top:23px;padding-left:10px;float:left;" src="http://tu.kagirl.net/pic/tubiao/tubiao_8.png"/>
    ...
    html_body += '<div  onclick="closeTBt()" style="position:relative;float:right;height:75px;width:75px;"><div style="position:relative;float:right;right:15px;top:20px;height:40px;width:40px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -135px transparent "></div></div></div>';
...
function on_selectweika_click()
{
    ...
    var html_body = '';
    html_body += '<div style="position:relative; width:100%;background:rgb(100,86,86);height:70px;-webkit-border-radius:5px 5px 0px 0px;border-bottom:1px solid yellow;"><div style="position:relative;float:left;left:10px;top:22px;height:40px;width:40px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -90px transparent "></div>';
...
function zan_click()
{
    if(zan == 0)
    {
        ...
        zkid('zan_image').style.background =  'url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -784px transparent';
        zan = 1;
        //点赞数加1
    ...
    else
    {
        ...
        zkid('zan_image').style.background =  'url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -716px transparent';
        zan = 0;
        //点赞数减1
        zkid('jia1').innerHTML = '-1';
...
function zk_create_modify()
{
    if(kawa_data.modify == 'yes' || kawa_data.replace_modify == 'yes')
    {
        ...
        body_html += '<div style="position:relative;float:left;top:20px;left:15%"><div style="height:40px;width:40px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 0px transparent "></div></div>';      //<img id="img_word" src="http://tu.kagirl.net/pic/tubiao/tubiao_1.png">
        ...
        body_html += '<div style="position:relative;float:left;top:20px;left:15%"><div style="height:40px;width:40px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -45px transparent "></div></div>';
        ...
        body_html += '<div style="position:relative;float:left;top:20px;left:13%"><div style="height:40px;width:40px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -90px transparent "></div></div>';
        ...
        divla.innerHTML = '<div style="height:50px;width:50px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -978px transparent" ></div>';
    ...
    else if(location.href.indexOf('facemodify') == -1)
    {
        ...
        divAdd.innerHTML = '<div id="add_quan" style="position:absolute;float:left;left:380px;height:60px;width:60px;top:0px;-webkit-transform: rotate(-45deg);"><div style="positioin:static;height:60px;width:60px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -540px transparent "></div></div><div id="add_jia" style="position:absolute;float:left;left:397px;height:30px;width:30px;top:15px;-webkit-transform: rotate(-45deg);-webkit-transition: -webkit-transform 0.5s linear;"><div style="positioin:static;height:30px;width:30px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll -16px -663px transparent "></div></div>';
        ...
        //赞
        //bg_htm += '<div id="zan_div" style="position:fixed;left:380px;display:none;top:18px;z-index:90001;-webkit-transition: -webkit-transform 0.5s ease-in;" onclick="zan_click()"><div id="zan_image" style="height:60px;width:60px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -716px transparent "></div></div>';
        bg_htm += '<div id="shu1" style="position:fixed;right:45px;display:none;top:19px;height:30px;z-index:90001;-webkit-transition: -webkit-transform 0.2s ease-in;"><div style="height:50px;width:30px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -850px transparent "></div></div>';
        ...
        bg_htm += "<div style='position:absolute;float:left;left:0px;top:0px;'><div id='sound_image' style='height:60px;width:60px;background:url(\"tpl/Wap/default/common/kawahk/common/tubiao.png\") no-repeat scroll 0 -540px transparent' ></div></div>";
        bg_htm += "<div style='position:absolute;float:left;left:13px;top:16px;'><div id='sound_image2' style='height:30px;width:30px;background:url(\"tpl/Wap/default/common/kawahk/common/tubiao.png\") no-repeat scroll 0 -405px transparent;-webkit-animation:rotatemusic 5s infinite linear' ></div></div>";//
        bg_htm += "<div style='position:absolute;float:left;left:11px;top:14px;'><div id='sound_image3' style='display:none;height:33px;width:40px;background:url(\"tpl/Wap/default/common/kawahk/common/tubiao.png\") no-repeat scroll 0 -930px transparent' ></div></div></div>";
        bg_htm += '<div id="shu2" style="position:fixed;right:45px;display:none;top:119px;height:30px;z-index:90001;-webkit-transition: -webkit-transform 0.2s ease-in;"><div style="height:50px;width:30px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -850px transparent "></div></div>';
        //改文字
        ...
        bg_htm += '<div style="position:absolute;float:left;left:0px;"><div style="height:60px;width:60px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -540px transparent" ></div></div>';
        bg_htm += '<div style="position:absolute;float:left;left:11px;top:13px;"><div style="height:40px;width:40px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -450px transparent" ></div></div></div>';
        bg_htm += '<div id="shu3" style="position:fixed;display:none;right:45px;top:220px;height:30px;z-index:90001;-webkit-transition: -webkit-transform 0.2s ease-in;"><div style="height:50px;width:30px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -850px transparent "></div></div>';
        //选微卡  215
        ...
        bg_htm += '<div style="position:absolute;float:left;left:0px;"><div style="height:60px;width:60px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -540px transparent" ></div></div>';
        bg_htm += '<div style="position:absolute;float:left;left:10px;top:18px;"><div style="height:40px;width:40px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -360px transparent" ></div></div></div>';
...
function setup_lines()
{
    for(i=0; i<mp3_list.mp3s.length; i++)
    {
        ...
        var div_html = '';
        div_html += '<div style="position:relative;float:left;padding-top:30px;left:5px;width:40px;height:40px"><div id="play_img_' + i + '" style="height:40px;width:40px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -495px transparent "></div></div>';//<img id=play_img_' + i + ' src="http://tu.kagirl.net/pic/tubiao/tubiao_15.png"/>
        ...
        div_html += '<div onclick="zk_buildmusic_card(' + i + ')" style="position:relative;float:right;right:2%;height:90px;width:60px;top:25px"><div id="ok_img_' + i + '" style="display:none;height:38px;width:60px;background:url(\'tpl/Wap/default/common/kawahk/common/tubiao.png\') no-repeat scroll 0 -610px transparent "></div></div>';
