function replaceReg(str){ 
		var reg = /[^"^'^=]http:\/\/\S+.mp3|[^"^'^=]http:\/\/\S+.wma|[^"^'^=]http:\/\/\S+.m4a\?fromtag=52/ig; 
		str = str.replace(reg,function(m){  var reEs = /http:\/\/\S+.mp3|http:\/\/\S+.wma|http:\/\/\S+.m4a\?fromtag=52/ig; m=reEs.exec(m); return '<audio src="'+m+'" preload="none"></audio>';});
